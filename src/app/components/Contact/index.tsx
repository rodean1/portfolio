  ...
  return (
    <Box
      ...
      sx={{
        ...
        padding: {
          xs: "50px 28px",
          md: "clamp(50px, 8vw, 96px) clamp(28px, 5vw, 64px)",
        },
        marginLeft: "auto",
        marginRight: "auto",
          ...
          <Box sx={{ marginTop: "28px" }}>
            <Box
              ...
              sx={{
                ...
                color: "#fff",
                boxShadow:
                  "0 1px 2px rgba(160,60,30,0.18), inset 0 1px 0 rgba(255,255,255,0.22)",
        ...
        >
          {links.map((link, linkIndex) => (
            <Box
              ...
              sx={{
                borderBottom:
                  linkIndex < links.length - 1 ? `1px solid ${T.line}` : "none",
              }}
            >
              <Box
                component="a"
