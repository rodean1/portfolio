...
import { PageSection, SectionIntro, SectionTitle } from "../styled";
import {
  SkillColumn,
  SkillColumnNumber,
  SkillColumnTitle,
...
const cols = [
  ...
  },
  {
    ...
    items: [
      ...
      "Auth, sessions, multi‑tenant patterns",
    ],
  },
  {
    num: "03",
  ...
  },
  {
    ...
    items: [
      ...
      "Auth0/Clerk | identity & SSO",
      "Mapping & notification APIs",
      "Third‑party API design & resilience",
    ],
  },
  {
    num: "06",
    ...
    items: [
      ...
      "Data‑driven decisions, DMAIC mindset",
      "Detail‑oriented, long‑term thinker",
    ],
  },
];
  ...
  return (
    <PageSection id="skills">
      <SectionIntro>
        ...
        <SectionTitle>What I reach for.</SectionTitle>
      </SectionIntro>
